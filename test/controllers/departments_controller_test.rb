...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { faculty_id: @department.faculty_id, name: @department.name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { faculty_id: @department.faculty_id, name: @department.name } }
